...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tr_status_pembiayaan', function (Blueprint $table) {
            $table->id();
        ...
        Schema::table('tr_status_pembiayaan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('tr_status_pembiayaan');
    }
};
